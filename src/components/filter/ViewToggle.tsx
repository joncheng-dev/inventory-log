  ...
  return (
    <div className='flex items-center gap-4'>
      <button id="list-view" onClick={toggleGridListView}>
        <svg className='cursor-pointer text-theme-primary hover:text-primary-500 transition-colors duration-200' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
