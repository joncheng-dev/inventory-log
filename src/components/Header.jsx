...
export default function Header() {
  return (
    <div className='w-full flex justify-between py-4 px-4 border border-amber-900'>
      <div className='flex'>
        <div className='content-around px-2 py-2'>
